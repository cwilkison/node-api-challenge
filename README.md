...
Middleware (extends functionality) and server-side routing.

- [x] Describe Middleware?

Middleware allows the developer to extend the features given by the Express Framework.
You can add features such as route handlers.

- [x] Describe a Resource?

The end point data of an API.

- [x] What can the API return to help clients know if a request was successful?

A  JSON status(200) code.
